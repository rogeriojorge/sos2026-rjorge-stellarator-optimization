...
![bg right:46% contain](../assets/figures/09_proxy_vs_nonlinear.png)
...
# The optimizer does exactly what we ask, not what we meant
...
![bg right:46% contain](../assets/figures/07_sfincs_d11_scan.png)
...
![bg right:46% contain](../assets/figures/07_er_roots.png)
...
![bg right:46% contain](../assets/figures/07_bootstrap_profile.png)
...
![bg right:46% contain](../assets/figures/09_w7x_clamping_cartoon.png)
...
![bg right:46% contain](../assets/figures/08_growth_rate_spectrum.png)
...
![bg right:46% contain](../assets/figures/08_frequency_spectrum.png)
...
# Transport metrics are gates, not decorations
