...
![bg right:46% contain](../assets/figures/01_hsx_surface.png)
...
# The optimizer sees artifacts, not intuition
...
![bg right:46% contain](../assets/figures/01_w7x_surface.png)
...
# Rotational transform is a target, not a decoration

![bg right:46% contain](../assets/figures/01_iota_profile.png)
...
![bg right:46% contain](../assets/figures/01_boundary_mode_scan.png)
...
![bg right:46% contain](../assets/figures/02_boozer_contour.png)
...
![bg right:46% contain](../assets/figures/02_boozer_spectrum.png)
...
![bg right:46% contain](../assets/figures/02_bad_mode_perturbation.png)
...
![bg right:46% contain](../assets/figures/03_epsilon_eff_comparison.png)
...
![bg right:46% contain](../assets/figures/03_epsilon_eff_sensitivity.png)
